...
<section class="space-y-6">
  <div class="animate-scale-up animation-duration-[0.5s]">
  ...
  <div class="animate-scale-up animation-duration-[0.7s]">
  ...
  <div class="animate-scale-up animation-duration-[0.9s]">
    {% include projects/gems/provet_client.html %}
  </div>
</section>

<h3 class="mt-12 mb-4 text-xl font-semibold animate-scale-up animation-duration-[1s]">Applications</h3>

<section class="space-y-6">
  <div class="animate-scale-up animation-duration-[1.1s]">
...
<h3 class="mt-12 mb-4 text-xl font-semibold animate-scale-up animation-duration-[1.3s]">Contributions</h3>
