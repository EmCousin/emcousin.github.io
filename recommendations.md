...
<section class="space-y-4">
  <div class="animate-flip-and-zoom-in animation-duration-[1.5s]">
    {% include recommendations/gumroad/gianfranco.html %}
  </div>
  ...
  <div class="animate-flip-and-zoom-in animation-duration-[1.5s] animation-delay-[0.8s]">
    {% include recommendations/reprtoir/steve.html %}
  </div>

  <div class="animate-flip-and-zoom-in animation-duration-[1.5s] animation-delay-[1.1s]">
  ...
  <div class="animate-flip-and-zoom-in animation-duration-[1.5s] animation-delay-[2.3s]">
    <p>
      Like me too?
